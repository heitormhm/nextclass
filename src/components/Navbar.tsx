      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            {!mobile && <span className="font-medium">{isTeacherMode ? 'Prof. Ana Santos' : 'Antônio'}</span>}
            {mobile && <span className="font-medium ml-1">{isTeacherMode ? 'Prof. Ana Santos' : 'Antônio'}</span>}
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          ...
                          >
                            ...
                            <span className="font-medium flex-1 text-left">{isTeacherMode ? 'Prof. Ana Santos' : 'Antônio'}</span>
                            <ChevronDown className="h-4 w-4" />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end" className="w-48">
