...
const mockNotifications = [
  ...
  { id: 2, text: 'A aula ao vivo de Análise de Circuitos começa em 1 hora.', time: '3h atrás' },
  { id: 3, text: 'Não se esqueça: a entrega do projeto de Mecânica dos Fluidos é em 3 dias.', time: '1d atrás' }
];
