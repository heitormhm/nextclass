/**
 * Lecture-specific Flashcards Generation (isolated from teacher routes)
...
serve(async (req) => {
  ...
  try {
    console.log('[lecture-generate-flashcards] Request received');
    ...
    supabaseAdmin.functions.invoke('teacher-job-runner', {
      ...
      console.error('[lecture-generate-flashcards] Error invoking job runner:', err);
    });
    ...
    console.error('[lecture-generate-flashcards] Error:', error);
    return new Response(
